			...
			<div class="content-top">
				<div class="top-box">
					...
					<?php 
						...
						$clientePedidosFinalizados = $pedidos->clientePedidosFinalizados(AuthComponent::user('id'));
						
						$contador=0;
						$contador2=0;
						while ($contador!=sizeof($clientePedidosFinalizados))
						{
							$status = $clientePedidosFinalizados[$contador]['tb_pedido']['status_pedido'];
							$id = $clientePedidosFinalizados[$contador]['tb_pedido']['id'];
					...
					<div class="top-box">
						<div style = "border: 1px solid RED; margin: 2px;" >
							<div class="panel-body">
								...
								<div align="center" style="height: 10px; width: 1140px; float: left; margin-left: 10px;">

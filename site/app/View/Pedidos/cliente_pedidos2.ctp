			...
			<div class="content-top">
				<div class="top-box">
					...
					<div class="btn-group btn-group-justified">
						<?php 
							echo $this->Html->link(
		        			$this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-random')) . " Andamento",
		        			array('controller' => 'pedidos', 'action' => 'clientePedidosFinalizados', AuthComponent::user('id'), 'role' => 'button'),
							array('class' => 'btn btn-success', 'escape' => false));
							echo $this->Html->link(
		        			$this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-pencil')) . " Finalizado",
		        			array('controller' => 'pedidos', 'action' => 'clientePedidosFinalizados'),
							array('class' => 'btn btn-default', 'escape' => false));
							echo $this->Html->link(
		        			$this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-heart-empty')) . " Disponível avaliação",
		        			array('controller' => 'pedidos', 'action' => 'clientePedidosFinalizados', AuthComponent::user('id'), 'role' => 'button'),
							array('class' => 'btn btn-info', 'escape' => false));		
							echo $this->Html->link(
		        			$this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-cutlery')) . " Solicitação de finalização",
		        			array('controller' => 'pedidos', 'action' => 'clientePedidosFinalizados', AuthComponent::user('id'), 'role' => 'button'),

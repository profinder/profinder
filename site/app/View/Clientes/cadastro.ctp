...
<div class="main">					
	<div class="wrap">
		<div class="content-top">
			<div class="top-box">
				<div style="background:url(/profinder/site/app/webroot/img/background.png) bottom no-repeat; height: 1000px; width: 1600px; margin-left: -200px; margin-top:-100px;">
					<div class="panel panel-default" style="height: 930px; width: 1000px; margin-left: 300px; margin-top:70px;">

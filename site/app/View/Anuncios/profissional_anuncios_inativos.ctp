			...
			<div class="content-top">
				<div class="top-box">
					...
					<?php 
						...
						$profissionalAnuncios = $anuncios->profissionalAnunciosInativos(AuthComponent::user('id'));
												
						if( $profissionalAnuncios == null )
						{
							echo "Nenhum anúncio inativo.";
						}
						else
						{
							$contador=0;
							...
							<center>		
							<ul class="pagination">
									<li><a href="/profinder/site/anuncios/profissionalAnunciosInativos?pag=1">&laquo;</a></li>
									<?php
										$contador = 1;
										while ( $contador < ((sizeof($profissionalAnuncios))/8)+1 ) {
									?>
											<li><a href="/profinder/site/anuncios/profissionalAnunciosInativos?pag=<?php echo $contador;?>"><?php echo $contador?></a></li>
											<?php
												$contador++;
										}
									?>
									<li><a href="/profinder/site/anuncios/profissionalAnunciosInativos?pag=<?php echo round((sizeof($profissionalAnuncios))/8);?>">&raquo;</a></li>
							</ul>
							</center>
						</div>
					</div>
